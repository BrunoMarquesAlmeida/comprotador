  ...
  return (
    <div className="col-lg-9">
      <div id="text-page" className="box">
        <h1>ComproTador</h1>
        <p className="lead">
          Sed non scelerisque nisi, condimentum scelerisque lectus. Sed
          convallis turpis nunc. Nulla fringilla metus at tristique gravida.
          Suspendisse placerat libero eu ultrices sollicitudin.
        </p>
        <p>
